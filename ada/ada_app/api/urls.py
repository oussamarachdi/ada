...
urlpatterns = [
    ...
    path('product/<id>/', ProductRudView.as_view(), name='product-rud'),
    path('category/', CategoryAPIView.as_view(), name='category-create'),
    path('category/<id>/', CategoryRudView.as_view(), name='category-rud'),
    path('subcategory/', SubCategoryAPIView.as_view(), name='subcategory-create'),
    path('subcategory/<id>/', SubCategoryRudView.as_view(), name='subcategory-rud'),
